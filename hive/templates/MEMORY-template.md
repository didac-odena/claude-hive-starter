...
11 agentes en 3 niveles. Invocar con `/agents/nivel/nombre`.
- **Estrategia:** /kadid (fundador+orquestador), /cto (arquitectura+seguridad), /cpo (producto+legal-producto)
- **Direccion:** /pm (coordinacion), /engineering-director (calidad+QA+data), /product-director (specs+UX), /marketing-legal (marketing+compliance+contenido legal)
